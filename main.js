...
//punho branca
  ...
  btncorvistaDpreto.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#E2DAC8";
    document.getElementById('VD').style.backgroundColor = "#E2DAC8";
  });
  //vistaD azul
  const btncorvistaDazul = document.getElementById('bluebase6');
  btncorvistaDazul.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#EFC46F";
    document.getElementById('VD').style.backgroundColor = "#EFC46F";
  });    
  //vistaD vermelha
  const btncorvistaDvermelha = document.getElementById('redbase6');
  btncorvistaDvermelha.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#B7B2A6";
    document.getElementById('VD').style.backgroundColor = "#B7B2A6";
  });  
  //vistaD amarela
  const btncorvistaDamarela = document.getElementById('yellowbase6');
  btncorvistaDamarela.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#A9BCC7";
    document.getElementById('VD').style.backgroundColor = "#A9BCC7";
  });  
  //vistaD verde
  const btncorvistaDverde = document.getElementById('greenbase6');
  btncorvistaDverde.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#7A98C1";
    document.getElementById('VD').style.backgroundColor = "#7A98C1";
  });
  ...
  btncorbolsoFpreto.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#E2DAC8";
    document.getElementById('BSF').style.backgroundColor = "#E2DAC8";
  });
  //Bolso Faixa azul
  const btncorbolsoFazul = document.getElementById('bluebase7');
  btncorbolsoFazul.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#EFC46F";
    document.getElementById('BSF').style.backgroundColor = "#EFC46F";
  });    
  ...
  btncorbolsoFvermelha.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#B7B2A6";
    document.getElementById('BSF').style.backgroundColor = "#B7B2A6";
  });  
  //Bolso Faixa amarela
  const btncorbolsoFamarela = document.getElementById('yellowbase7');
  btncorbolsoFamarela.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#A9BCC7";
    document.getElementById('BSF').style.backgroundColor = "#A9BCC7";
  });  
  //Bolso Faixa verde
  const btncorbolsoFverde = document.getElementById('greenbase7');
  btncorbolsoFverde.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#7A98C1";
    document.getElementById('BSF').style.backgroundColor = "#7A98C1";
  });
  ...
  btncorbolsoBpreto.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#E2DAC8";
    document.getElementById('BB').style.backgroundColor = "#E2DAC8";
  });
  //Bolso Faixa azul
  const btncorbolsoBazul = document.getElementById('bluebase8');
  btncorbolsoBazul.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#EFC46F";
    document.getElementById('BB').style.backgroundColor = "#EFC46F";
  });    
  //Bolso Faixa vermelha
  const btncorbolsoBvermelha = document.getElementById('redbase8');
  btncorbolsoBvermelha.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#B7B2A6";
    document.getElementById('BB').style.backgroundColor = "#B7B2A6";
  });  
  //Bolso Faixa amarela
  const btncorbolsoBamarela = document.getElementById('yellowbase8');
  btncorbolsoBamarela.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#A9BCC7";
    document.getElementById('BB').style.backgroundColor = "#A9BCC7";
  });  
  //Bolso Faixa verde
  const btncorbolsoBverde = document.getElementById('greenbase8');
  btncorbolsoBverde.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#7A98C1";
    document.getElementById('BB').style.backgroundColor = "#7A98C1";
  });
